...
public class LoginController {
    ...
    @PostMapping("/login")
    @OperationLogIgnore
    @ApiOperation(value = "登录", notes = "系统用户登录", response = com.syyang.springbootplus.system.vo.LoginSysUserTokenVo.class)
    public ApiResult<LoginSysUserTokenVo> login(@Validated @RequestBody com.syyang.springbootplus.system.param.LoginParam loginParam, HttpServletResponse response) throws Exception {
